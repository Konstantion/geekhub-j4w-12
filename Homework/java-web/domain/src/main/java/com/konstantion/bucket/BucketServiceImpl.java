...
public record BucketServiceImpl(ProductRepository productRepository, ProductService productService)
    ...
    @Override
    public List<Product> getBucketProducts(Bucket bucket) {
    ...
    @Override
    public Product addProductToBucket(Bucket bucket, UUID productUuid, Integer quantity) {
        Product product = productService.getById(productUuid);
